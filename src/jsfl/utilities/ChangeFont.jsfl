...
function processAllTimelines(){
	...
	fl.trace("RunnprocessAllTimelinesing");
...
function processTimeline(theTimeline){
	...
	var oldString = "Speakaboos*";
	var newString = "TitleFont*";
	
	fl.trace("oldString: "+oldString);
	fl.trace("newString: "+newString);
